...
const HomeBanner = () => {
    return ( 
        <div className="relative bg-gradient-to-r from-sky-500 to-sky-700 mb-8">
            <div className="mx-auto px-8 py-12 flex flex-col gap-4 md:flex-row items-center justify-evenly">
                ...
                <div className="w-1/3 relative aspect-video">
                    <Image src='/banner-image.png' fill alt='Banner Image'className="object-contain" sizes="20" priority/>
                </div>
            </div>
        </div>
     );
